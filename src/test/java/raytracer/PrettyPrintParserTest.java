...
public class PrettyPrintParserTest {
    private static String LOG_PATH = "./out/PrettyPrintParserTest.md";
    private static StringBuilder STRING_BUILDER = new StringBuilder();
    private static int TOTAL_SCORE = 2;
    ...
    public static void afterClass() throws IOException {
        ...
        logFile.write("## PrettyPrintParser.java: TEST SCORE (" + SCORE + "/" + TOTAL_SCORE + ")\n");
